...
const Contact = () => {
  ...
  const empty = () =>
    toast.error(getTranslation(language, 'toastEmpty'), {
      id: "error",
    });

  const error = () =>
    toast.error(getTranslation(language, 'toastError'), {
      id: "error",
    });

  const success = () =>
    toast.success(getTranslation(language, 'toastSuccess'), {
      id: "success",
    });
      ...
      <div className="section-container flex flex-col justify-center">
        <div className="flex flex-col contact-wrapper">
          <div className="flex flex-col">
            ...
            >
              {getTranslation(language, 'contactLabel')}
            </motion.p>
            <motion.h1 
              initial={{ opacity: 0, x: -30 }}
              whileInView={{ opacity: 1, x: 0 }}
